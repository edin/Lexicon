...
final class XmlProcessingInstructionTokenMatcher implements TokenMatcherInterface
{
    ...
    public function match(Lexer $lexer): ?Token
    {
        ...
        if ($lexer->tryTake('?>')) {
            ...
            $lexer->diagnostics->report($location, 'Unterminated XML processing instruction.');
        }
